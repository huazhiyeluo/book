...
var _default = {
  ...
  methods: {
    ...
    getPrize: function getPrize() {
      var players = htmzplayer[this.form1.max_player]['max_player'];
      var num = parseInt(htmz[this.form1.price]['price']) * parseInt(players) * htmzfee[this.form1.fee]['fee'] / 100;
...
//# sourceMappingURL=app.da693217cb3448386001.hot-update.js.map